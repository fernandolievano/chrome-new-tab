  ...
  return (
    <div className="absolute w-screen h-screen overflow-hidden">
      ...
      <div className="absolute top-0 right-0 px-6 py-6">
        ...
        <label
          htmlFor="fileInput"
          className="flex items-center justify-center w-8 h-8 transition-all bg-white/10 border border-white/15 rounded-full shadow-sm cursor-pointer backdrop-blur-md hover:bg-black/30"
